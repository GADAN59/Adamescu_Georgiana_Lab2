...
namespace Adamescu_Georgiana_Lab2.Migrations
{
    ...
    [Migration("20231112193015_Lab3Ex18")]
    partial class Lab3Ex18
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adamescu_Georgiana_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Adamescu_Georgiana_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Adamescu_Georgiana_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Adamescu_Georgiana_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adamescu_Georgiana_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
